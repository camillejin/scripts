...
>>>>>>> 1af08e6ad2debb72fca2976aa40042f831d13fc8
...
void loop(void)
{
  *(uint8_t*)0x20001700 = 0x12;
  *(uint8_t*)0x20001701 = 1;
  *(uint16_t*)0x20001702 = 0;
  *(uint8_t*)0x20001704 = 0xad;
  *(uint8_t*)0x20001705 = 0xd2;
  *(uint8_t*)0x20001706 = 0xc1;
  *(uint8_t*)0x20001707 = 8;
  *(uint16_t*)0x20001708 = 0x9022;
  *(uint16_t*)0x2000170a = 0xd421;
  *(uint16_t*)0x2000170c = 0xd3e1;
  *(uint8_t*)0x2000170e = 1;
  *(uint8_t*)0x2000170f = 2;
  *(uint8_t*)0x20001710 = 3;
  *(uint8_t*)0x20001711 = 1;
  *(uint8_t*)0x20001712 = 9;
  *(uint8_t*)0x20001713 = 2;
  *(uint16_t*)0x20001714 = 0x12;
  *(uint8_t*)0x20001716 = 1;
  *(uint8_t*)0x20001717 = 0;
  *(uint8_t*)0x20001718 = 0;
  *(uint8_t*)0x20001719 = 0;
  *(uint8_t*)0x2000171a = 0;
  *(uint8_t*)0x2000171b = 9;
  *(uint8_t*)0x2000171c = 4;
  *(uint8_t*)0x2000171d = 0x39;
  *(uint8_t*)0x2000171e = 0;
  *(uint8_t*)0x2000171f = 0;
  *(uint8_t*)0x20001720 = 0x82;
  *(uint8_t*)0x20001721 = 0x5e;
  *(uint8_t*)0x20001722 = 0x74;
  *(uint8_t*)0x20001723 = 0;
  syz_usb_connect(0, 0x24, 0x20001700, 0);
  close_fds();
}
int main(void)
{
